          ...
          <ExpandableCardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <Sun className="mr-2 size-8 text-yellow-400" />
          ...
          <ExpandableCardContent>
            ...
            >
              <div className="mb-4 space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <Cloud className="mr-2 size-5 text-gray-400" />
                    <span>Humidity</span>
                  </div>
                  <span>45%</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <Wind className="mr-2 size-5 text-gray-400" />
                    <span>Wind</span>
                  </div>
                  <span>8 mph</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <Droplets className="mr-2 size-5 text-gray-400" />
              ...
              <div className="space-y-2">
                ...
                {["Mon", "Tue", "Wed", "Thu", "Fri"].map((day, index) => (
                  <div key={day} className="flex items-center justify-between">
                    <span>{day}</span>
                    <div className="flex items-center">
                      <Sun className="mr-2 size-4 text-yellow-400" />
