  ...
  be: (props: any) => (
    ...
    >
      <rect
        ...
        rx="14"
        fill="#D9D9D9"
        className="fill-[#D9D9D9] group-hover:fill-accent transition-all ease-in-out duration-500"
      />
      <path
        fill-rule="evenodd"
        className="fill-black transition-all ease-in-out duration-500 group-hover:fill-white"
        clip-rule="evenodd"
