...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      primary:
        "w-full border border-black/10 bg-gradient-to-b from-black/70 to-black p-px transition duration-300 ease-in-out dark:border-2 dark:border-black dark:from-white dark:to-white/80 ",
      accent:
        "w-full border border-black/10 bg-gradient-to-b from-indigo-300/90 to-indigo-500 p-px transition duration-300 ease-in-out dark:border-2 dark:border-neutral-950 dark:from-indigo-200/70 dark:to-indigo-500 ",
      destructive:
        "w-full border border-black/10 bg-gradient-to-b from-red-300/90 to-red-500 p-px transition duration-300 ease-in-out dark:border-2 dark:border-neutral-950 dark:from-red-300/90 dark:to-red-500 ",
      secondary:
        "w-full border border-black/20 bg-white/50 p-px transition duration-300 ease-in-out dark:border-2 dark:border-neutral-950 dark:bg-neutral-600/50 ",
      minimal:
        "group  w-full border border-black/20 bg-white/50 to-white p-px hover:bg-gradient-to-t hover:from-neutral-100  active:bg-neutral-200 dark:border-2 dark:border-neutral-950 dark:bg-neutral-600/80 dark:hover:from-neutral-600/50 dark:hover:to-neutral-600/70 dark:active:bg-neutral-800",
      icon: "group rounded-full border border-black/10 bg-white/50 to-white p-px hover:bg-gradient-to-t hover:from-neutral-100 active:bg-neutral-200 dark:border-neutral-950 dark:bg-neutral-600/50 dark:hover:from-neutral-700 dark:hover:to-neutral-600 dark:active:bg-neutral-800",
    },
    size: {
      sm: "rounded-[6px]",
