...
export function LatestComponent() {
  return (
    ...
    <div className=" relative mx-auto flex w-full flex-col rounded-[24px] border border-black/5 bg-neutral-800/5 p-2 shadow-sm md:flex-row md:items-center md:gap-24 md:rounded-b-[20px] md:rounded-t-[40px] md:p-2">
      ...
      <div className="ml-auto mt-4 flex max-w-xl grow flex-col items-center justify-center space-y-0 rounded-[14px] border border-dashed border-black/10  bg-neutral-500/20 p-4 md:mt-0 md:rounded-md md:rounded-br-[20px] md:rounded-tr-[35px]">
        <ContactFormExample />
      </div>
    </div>
  )
...
export function LatestComponentVertical() {
  return (
    ...
    <div className=" relative mx-auto flex w-full flex-col rounded-[24px] border border-black/5 bg-neutral-800/5 p-2 shadow-sm  md:items-start md:gap-8 md:rounded-b-[20px] md:rounded-t-[40px] md:p-2">
      ...
      {/* <div className=" mt-4 flex max-w-xl grow flex-col items-center justify-center space-y-0 rounded-[14px] border border-dashed border-black/10  bg-neutral-500/20 p-4 md:mt-0 md:rounded-md md:rounded-br-[20px] md:rounded-tr-[35px]"> */}
...
export function LatestComponentHorizonatal() {
  return (
    // <div className=" relative flex w-full flex-col rounded-[24px] border border-black/5 bg-neutral-800/10 p-2 shadow-sm md:flex-row md:items-center md:gap-24 md:rounded-t-[40px] md:p-2 mx-auto">
    <div className=" relative mx-auto flex w-full flex-col rounded-[24px] border border-black/5 bg-neutral-800/5 p-2 shadow-sm  md:items-start md:gap-8 md:rounded-b-[20px] md:rounded-t-[40px] md:p-2">
      <Badge
