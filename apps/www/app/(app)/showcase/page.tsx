  ...
  return (
    <>
      <div className="mt-32 space-y-4 ">
        ...
        <p className="mx-2 text-center  text-base  leading-5 text-foreground md:pt-8 md:text-xl  md:font-normal " >Real time use case of our industry ready  components Comming soon ! </p>
          ...
          <FadeIn>
            <div className=" mx-auto max-w-4xl rounded-[40px] border border-black/5 p-2 shadow-sm ">
              <div className=" relative mx-auto h-[470px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 bg-[#ff4017] p-2 shadow-sm md:h-[400px] ">
                <p className=" mt-20 text-center text-white" >Bringing simplicity to the future in </p>
