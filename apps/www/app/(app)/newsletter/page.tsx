...
import { JsonLd, generateCompleteLibraryJsonLd } from "@/lib/json-ld"
...
function SubscriptionForm() {
  ...
  return (
    <div className="mt-6 flex w-full px-10 md:px-32 flex-col items-center justify-center gap-3">
      ...
      <div>
        <button
          ...
          className="flex mt-4 relative  items-center justify-center "
        >
          <div
            className={cn(
          ...
          >
            <div
              className={cn(
                "border border-[#3B3A3A] bg-[#ff3f17]  h-[43px] rounded-full flex items-center justify-center text-white"
              )}
            >
      ...
      <div className=" relative overflow-hidden h-screen flex flex-col items-center justify-center">
        <div className="  z-10 max-w-2xl md:max-w-4xl space-y-4 flex flex-col items-center justify-center">
          <GradientHeading
            size="xll"
            weight="bold"
            className="text-center text-xl font-bold  tracking-tighter lg:leading-[0.5rem] sm:max-w-4xl "
          >
            Join our Newsletter
          </GradientHeading>
        ...
        <motion.div
          ...
          className=" -bottom-[4rem]  sm:-bottom-[17rem] -z-8 absolute"
          initial="hidden"
          animate="visible"
        >
          <motion.h2
            variants={itemVariants}
            className=" text-[110px] sm:text-[450px] tracking-tighter text-black/5 dark:text-white/5 "
          >
            Skiper/ui
          </motion.h2>
        </motion.div>
