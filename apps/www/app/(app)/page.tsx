...
export default function IndexPage() {
  ...
  return (
    <div className="isolate flex min-h-screen flex-col items-center justify-center overflow-hidden  pb-8 sm:pb-12 md:pb-0">
        ...
        <FadeIn>
          <section className="w-ace-y-4 ">
            ...
            <section className=" mt-12 w-full">
              <FadeIn >
                <StatisticHighlight text='of Next Js Saas Products Looks similar right ? Lets Change the approach' num={70} />
              </FadeIn>
      ...
      <section className=" mt-12 w-full ">
        <StatisticHighlight text={`of users judge a business's credibility by its website design quality.`} num={90} />
