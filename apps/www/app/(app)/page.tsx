...
import ThemeToggleAnimationsDemo from "@/registry/default/example/theme-toggle-animation-demo"
import { GradientHeading } from "@/registry/default/ui/gradient-heading"

import StatisticHighlight from "./components/StatisticHighlight"
import AiInput from "./newsletter/ai-input"
      ...
      <div className="data:bg-black container relative pt-12 md:pt-8">
        <PageHeader>
          ...
          <div className="pt-4 md:pt-0">
            <GradientHeading weight="bold" className="text-center mt-4">
              Components crafted for
            </GradientHeading>
            <GradientHeading size="xll" weight="bold">
              Modern Websites
            </GradientHeading>
          </div>
          ...
          <p className=" leading-2 flex max-w-2xl flex-wrap items-center justify-center gap-1 text-center  text-black/60 dark:text-white/80 md:pt-8 md:text-xl md:font-normal md:leading-6">
            To make your dream Website live by just <b>Copy and paste</b> <br />
          </p>
        </PageHeader>
