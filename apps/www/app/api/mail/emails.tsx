...
export const NotionWaitlistEmail = ({
  userFirstname = "Gurvinder",
}: EmailProps) => (
  <Html>
    <Head />
    ...
    >
      <Container style={{ ...containerStyle, backgroundColor: "#ffffff" }}>
        ...
        <Section style={{ textAlign: "center", margin: "20px 0" }}>
          <Img
            src={`https://legacy.skiper-ui.com/static/arrow.png`}
            width="125"
            alt="Skiper/ui"
            style={logo}
          />
          ...
          <Img
            src={`https://legacy.skiper-ui.com/static/cta.png`}
            width="212"
            alt="Skiper/ui"
            style={logo}
          />
        ...
        <Section style={{ ...cardStyle, marginBottom: "100px" }}>
          <div style={innerCardStyle}>
            ...
            >
              ...
              <br />
              <br /> We're all about keeping it real, transparent, and
              ridiculously fun. You're
              <br /> officially in for an exciting ride.
              <br />
              <br /> Thanks for hopping on board!
              <br />
        ...
        <Img
          src={`https://legacy.skiper-ui.com/static/badge.png`}
          width="120"
          alt="Skiper/ui"
          style={{ margin: "auto" }}
        />
        <Section style={{ textAlign: "center", margin: "0" }}>
          ...
          >
            Got questions or just want to say hi? Reach out to us anytime at{" "}
            <a style={{ color: "#404040" }} href="http://x.com/guri_who">
              gxuri
            </a>
          </Text>
        </Section>
